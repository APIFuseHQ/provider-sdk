...
const forgottenExportAllowlist: Record<string, ForgottenExportAllowance> = {
	...
	"runtime-resolver.api.md": forgottenExports(
		...
		`
			...
			ProxyVendorFailoverTelemetryEvent ProxyVendorName ResolverChainClient ResolverContext ResolverIdentity ResolverIssuingIdentity ResolverPaidUsageContext ResolverVendorAdapter ResolverVendorTransport
