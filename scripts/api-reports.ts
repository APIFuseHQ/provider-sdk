...
const forgottenExportAllowlist: Record<string, ForgottenExportAllowance> = {
	...
	"server.api.md": forgottenExports(
		...
		`
			...
			ProviderCacheResult ProviderChallenge ProviderChallengeKind
			ProviderContext ProviderDefinition ProviderDeploymentOverrides ProviderErrorCategory ProviderErrorStatus
