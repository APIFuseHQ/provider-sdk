...
const forgottenExportAllowlist: Record<string, ForgottenExportAllowance> = {
	...
	"contract.api.md": forgottenExports(
		...
		`
			...
			HealthJourneyRunResult HealthJourneySchedule HealthJourneySmsContext HealthJourneyStep HealthMonitorProbeOverride HealthScheduleRandomization HttpAttemptContext HttpClient HttpHeadersFactory HttpMethod
			...
			OperationApprovalPolicy OperationContractMetadata OperationDefinition OperationDeprecationMetadata OperationErrorCode OperationExample OperationHandlerResult
			OperationHttpStreamTransport OperationJsonTransport OperationLifecycle OperationObservabilityConfig OperationObservabilitySensitiveConfig OperationRelationships OperationRiskClass
			OperationSensitivePath OperationSseTransport OperationTransport OperationWebSocketTransport ProbeInterval ProviderAccessConfig ProviderAccessVisibility
			...
			ProviderReviewed ProviderRuntimeState ProviderRuntimeTarget ProviderSecretDeclaration ProviderSecretIssuer ProviderStateDurationString ProviderStateNamespace ProviderStreamEvent ProviderSttConfig ProviderSttMode
	...
	"index.api.md": forgottenExports(
		...
		`
			...
			ProviderContractMetaLike ProviderImplementationCredentialStrategy ProviderImplementationProfile ProviderImplementationSourceAccess ProviderLintMode ProviderLintOptions
	...
	"provider.api.md": forgottenExports(
		...
		`
			...
			ContextScratchpad CookieJar CredentialContext CredentialDeclaration DeclarativeStealthResponse E164PhoneNumber EnvContext 
			HealthCheckCaseResult HealthCheckInputPreparationContext HealthJourneyGatewayContext HealthJourneyJournalContext HealthJourneySchedule HealthJourneySmsContext HealthJourneyStep
			...
			OcrWarning OperationConfig OperationDeprecationMetadata OperationHandlerResult OperationHttpStreamTransport OperationJsonTransport OperationMapConfig
			OperationSseTransport OperationWebSocketTransport PROVIDER_ERROR_CATEGORIES ProbeInterval ProviderAccessConfig ProviderCache ProviderCacheGetOrSetOptions
			ProviderCacheKeyOptions ProviderCacheLookupMeta ProviderCacheResponseMeta ProviderCacheResult ProviderChallenge ProviderChallengeKind
			...
			ProviderProxySessionAffinity ProviderRequestContext ProviderResolverConfig ProviderResolverVendor ProviderReviewed ProviderSecretDeclaration ProviderSecretIssuer ProviderStreamEvent ProviderSttConfig
	...
	"runtime-native-network.api.md": forgottenExports(
		...
		`
			...
			ProviderErrorMessageParams ProviderErrorObservability ProviderErrorOptions ProviderLocaleKey ProviderLocaleKeyInput ProviderProxyMode ProviderProxyPolicy ProviderProxyProvider ProviderProxySessionAffinity ProxyProtocol TransportError TransportErrorOptions NativeConnectTelemetryEvent NativeLifecycleTelemetryEvent NativeTelemetryDiagnostics NativeTelemetryErrorCode NativeTelemetryKind NativeTelemetryLifecycleKind NativeTelemetryOutcome NativeTelemetrySink NativeTelemetryVendorSkipReason NativeVendorSkipTelemetryEvent ProxyAttemptTelemetryEvent ProxyCacheStatus ProxyResolutionTelemetryEvent ProxyTelemetrySink ProxyUserAgentSource ProxyVendorFailoverTelemetryEvent ProxyVendorName SmartproxyAllocatorBodyClass
		`,
	),
	...
	"runtime-stealth.api.md": forgottenExports(
		"These pre-existing indirect declarations are intentionally not direct entry-point exports; their full definitions are included in this report for semver review.",
		`
			CookieJar DeclarativeStealthResponse HttpAttemptContext HttpHeadersFactory HttpMethod HttpRedirectPolicy HttpRedirectPolicyMode HttpRetryAfterPolicy HttpRetryDelayStrategy HttpRetryJitter
	...
	"server.api.md": forgottenExports(
		...
		`
			...
			HttpAttemptContext HttpClient HttpHeadersFactory HttpMethod HttpRedirectPolicy HttpRedirectPolicyMode HttpResponse HttpRetryAfterPolicy HttpRetryDelayStrategy HttpRetryJitter
			...
			OcrResult OcrWarning OperationApprovalPolicy OperationContractMetadata OperationDefinition OperationDeprecationMetadata
			OperationErrorCode OperationExample OperationHandlerResult OperationHttpStreamTransport OperationJsonTransport OperationLifecycle OperationObservabilityConfig OperationObservabilitySensitiveConfig
			OperationRelationships OperationRiskClass OperationSensitivePath OperationSseTransport OperationTransport OperationWebSocketTransport PROVIDER_ERROR_CATEGORIES
			...
			ProviderCacheResult ProviderChallenge ProviderChallengeKind ProviderContext ProviderDefinition ProviderDeploymentOverrides ProviderErrorCategory ProviderErrorStatus
			...
			ProviderEngine ProviderEngineAttachmentInput ProviderEngineBindingCandidates ProviderEngineCapabilitySurface ProviderEngineMode ProviderEngineResidentSurface
			ProviderRequestContext ProviderRequestCost ProviderResolvedFile ProviderResolverConfig ProviderResolverVendor ProviderReviewed ProviderRuntimeState ProviderRuntimeTarget ProviderSecretDeclaration ProviderSecretIssuer
			...
			RequestWithMethodOptions ResolverContext SchemaLike SelfTestCancellationLogEvent SmsOrigin SmsOtpExtractionPattern SmsOtpMatcherDefinition SmsPhoneIdentity ProxyResolutionTelemetryEvent ProxyTelemetrySink
			...
			SttTranscript SttUnsupportedOptionPolicy SttUsage SttVerificationCodeOptions SttWarning TraceAttributeValue TraceContext_2 TraceSpan VALID_OPERATION_ERROR_STATUSES VerificationCodeCandidate
			VerificationCodeCandidateSource VerificationCodeExtractionResult
			AssertStep AssertionExpression AssertionPredicate AttemptReference BoundedJsonPath BoundedJsonPathSchema CandidateBlock CandidatePolicy CandidateReference
			CredentialRefDeclaration CredentialReference ExtractStep FindFirst GuardAttribution GuardReasonCode GuardStep HealthJourneyDefinitionBase HealthScenario HealthStep
