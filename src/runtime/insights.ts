...
const TLS_REUSE_FIX = `const session = ctx.stealth.createSession({ stealth: { profile: 'chrome-desktop' } });
...
const session = ctx.stealth.createSession({ stealth: { profile: 'chrome-desktop' } });
