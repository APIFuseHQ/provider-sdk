...
export const AuthFlowRequestSchema: z.ZodObject<{
    ...
    engine: z.ZodOptional<z.ZodObject<{
        egressLease: z.ZodOptional<z.ZodString>;
    }, z.core.$strict>>;
...
// Warning: (ae-forgotten-export) The symbol "HandleKindBase" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
interface CursorKind<TSchema extends ZodType = ZodType> extends HandleKindBase<TSchema> {
    // Warning: (ae-forgotten-export) The symbol "HandleStrength" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    readonly strength: HandleStrength;
    // Warning: (ae-forgotten-export) The symbol "ProviderStateDurationString" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
...
// Warning: (ae-forgotten-export) The symbol "HandleKind" needs to be exported by the entry point index.d.ts
//
// @public
...
interface HandleContext {
    // Warning: (ae-forgotten-export) The symbol "HandleCommitResult" needs to be exported by the entry point index.d.ts
...
// Warning: (ae-forgotten-export) The symbol "HandleKindDeclaration" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
interface HandleKindBase<TSchema extends ZodType = ZodType> extends HandleKindDeclaration {
    ...
    // Warning: (ae-forgotten-export) The symbol "HandleWordCount" needs to be exported by the entry point index.d.ts
...
// @public (undocumented)
type HandleOperation = "create" | "read" | "update" | "commit" | "discard";
...
interface HandleRecord<K extends HandleKind> {
    ...
    // (undocumented)
    readonly result?: ResultOf<K>;
    // Warning: (ae-forgotten-export) The symbol "HandleStatus" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
...
// @public
interface HandleTelemetryEvent {
    // (undocumented)
    readonly kind: string;
    readonly normalization: string;
    // Warning: (ae-forgotten-export) The symbol "HandleOperation" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    readonly operation: HandleOperation;
    // Warning: (ae-forgotten-export) The symbol "HandleTelemetryOutcome" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
...
// @public (undocumented)
type HandleTelemetryOutcome = "success" | "not_found" | "expired" | "invalid" | "kind_mismatch" | "busy" | "replayed" | "error";
...
// Warning: (ae-forgotten-export) The symbol "HandleTelemetryEvent" needs to be exported by the entry point index.d.ts
...
// Warning: (ae-forgotten-export) The symbol "StealthProfileSelection" needs to be exported by the entry point index.d.ts
//
// @public
...
// dist/server/serve-implementation.d.ts:147:5 - (ae-forgotten-export) The symbol "ProviderEngine" needs to be exported by the entry point index.d.ts
// dist/server/serve-implementation.d.ts:159:9 - (ae-forgotten-export) The symbol "ProviderServerStatefulOwnerFenceValidator" needs to be exported by the entry point index.d.ts
...
// dist/types.d.ts:566:5 - (ae-forgotten-export) The symbol "HealthJourneyRunContext" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:566:5 - (ae-forgotten-export) The symbol "HealthJourneyRunResult" needs to be exported by the entry point index.d.ts
...
// dist/types.d.ts:674:5 - (ae-forgotten-export) The symbol "HealthCheckAssertionContext" needs to be exported by the entry point index.d.ts
...
// dist/types.d.ts:1282:9 - (ae-forgotten-export) The symbol "StealthRedirectRunOptions" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1282:9 - (ae-forgotten-export) The symbol "StealthRedirectRunResult" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1483:9 - (ae-forgotten-export) The symbol "NativeTcpEgressRule" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1484:9 - (ae-forgotten-export) The symbol "NativeTcpDynamicEgressRule" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1589:5 - (ae-forgotten-export) The symbol "BrowserResourceBody" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1595:5 - (ae-forgotten-export) The symbol "BrowserResourceRequest" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1596:5 - (ae-forgotten-export) The symbol "BrowserResourceDecision" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1600:5 - (ae-forgotten-export) The symbol "BrowserResourceMethod" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1607:5 - (ae-forgotten-export) The symbol "BrowserResourceRoute" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1642:5 - (ae-forgotten-export) The symbol "BrowserChallengeRequest" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1730:9 - (ae-forgotten-export) The symbol "AuthSafeData" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1738:9 - (ae-forgotten-export) The symbol "AuthAbortRetry" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1739:9 - (ae-forgotten-export) The symbol "AuthSafeJson" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1748:9 - (ae-forgotten-export) The symbol "ProviderLocaleKeyInput" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1899:5 - (ae-forgotten-export) The symbol "ProviderRequestContext" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1914:5 - (ae-forgotten-export) The symbol "ProviderFilesContext" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1920:5 - (ae-forgotten-export) The symbol "ProviderCache" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1926:5 - (ae-forgotten-export) The symbol "BrowserClient" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1928:5 - (ae-forgotten-export) The symbol "AuthContext" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:1936:5 - (ae-forgotten-export) The symbol "HandleContext" needs to be exported by the entry point index.d.ts
// dist/types.d.ts:2023:9 - (ae-forgotten-export) The symbol "ProviderProxyPolicy" needs to be exported by the entry point index.d.ts
