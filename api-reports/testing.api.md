...
// @public (undocumented)
type ShapeMatcher = "array" | "boolean" | "null" | "number" | "object" | "string" | "undefined";
...
// Warning: (ae-forgotten-export) The symbol "ShapeMatcher" needs to be exported by the entry point index.d.ts
// Warning: (ae-forgotten-export) The symbol "ShapeObject" needs to be exported by the entry point index.d.ts
// Warning: (ae-forgotten-export) The symbol "ShapeArray" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
